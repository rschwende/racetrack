...
pub const TERRAIN_OFFSET: f32 = 5.; // how much the terrain extends past track

pub fn set_global_state(mut global_state: ResMut<GlobalState>) {
    global_state.frequency_scale = 0.02;
    global_state.amplitude_scale = 8.;
    global_state.octaves = 2;
