...
pub fn ui_example_system(
    ...
    egui::SidePanel::right("right_panel")
        ...
        .show(ctx, |ui| {
            ...
            ui.add(egui::Slider::new(&mut global_state.frequency_scale, 0.0..=1.0).text("Frequency Scale"));
            ui.add(egui::Slider::new(&mut global_state.amplitude_scale, 0.0..=1.0).text("Amplitude Scale"));
